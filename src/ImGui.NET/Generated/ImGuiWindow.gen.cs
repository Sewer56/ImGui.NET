...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiWindowPtr
    {
        ...
        public void MenuBarRect(ImGuiWindowPtr self)
        {
            ImGuiWindow* native_self = self.NativePtr;
            ImGuiNative.ImGuiWindow_MenuBarRect(NativePtr, native_self);
        }
        public void Rect(ImGuiWindowPtr self)
        {
            ImGuiWindow* native_self = self.NativePtr;
            ImGuiNative.ImGuiWindow_Rect(NativePtr, native_self);
        }
        ...
        public void TitleBarRect(ImGuiWindowPtr self)
        {
            ImGuiWindow* native_self = self.NativePtr;
            ImGuiNative.ImGuiWindow_TitleBarRect(NativePtr, native_self);
        }
    }
}
